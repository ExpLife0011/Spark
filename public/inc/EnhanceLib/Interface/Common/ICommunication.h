...
public:
    ...
    virtual BOOL WINAPI SendRequest(DWORD Type, IPacketBuffer* Buffer, HANDLE DoneEvent) = 0;

    virtual BOOL WINAPI SendRespone(DWORD Type, IPacketBuffer* Buffer, WORD Id, HANDLE DoneEvent) = 0;
